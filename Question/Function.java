public class Main
//Link for Replit: https://repl.it/@osolar1/Q6#Main.java
{
...
return "not equal";
 ...
 return "No Condition fulfilled";
   ...
   System.out.println(arithmetic_op());
   System.out.println(unary_op());
   Main m =new Main();
   System.out.println(m.logic_op());

  System.out.println(bitwise_op());
